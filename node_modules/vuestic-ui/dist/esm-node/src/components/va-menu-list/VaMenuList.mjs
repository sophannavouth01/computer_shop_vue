import { _ as _sfc_main } from "./VaMenuList.vue_vue_type_script_lang.mjs";
...
const _VaMenuList = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  _VaMenuList as _
};
//# sourceMappingURL=VaMenuList.mjs.map
