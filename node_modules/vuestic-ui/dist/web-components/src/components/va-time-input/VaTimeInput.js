...
const _style_0 = ".va-time-input__side-button {\n  pointer-events: none;\n}";
...
const _VaTimeInput = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [...(_sfc_main.components ? Object.values(_sfc_main.components) : []).map((c) => c.styles || []).flat(), _style_0]]]);
export {
  _VaTimeInput as _
};
