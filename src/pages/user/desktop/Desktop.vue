				...
				<div
					...
					<div v-for="item in filteredProductsAppleDesktop" :key="item.id">
						<div class="relative group">
							<div	class="flex justify-center items-center opacity-0 bg-gradient-to-t from-gray-800 via-gray-800 to-opacity-30 group-hover:opacity-50 absolute top-0 left-0 h-full w-full">
							</div>
				...
				<div
					...
					<div v-for="item in  filteredProductsMSIDesktop" :key="item.id">
						<div class="relative group">
							...
							<div class="absolute bottom-0 p-8 w-full opacity-0 group-hover:opacity-100">	
								<button @click="this.$router.push(`detail/${item.id}`)"	class="bg-transparent font-medium text-base leading-3 border-2 border-white py-3 w-full mt-2 text-white">View</button>
