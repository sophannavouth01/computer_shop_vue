				...
				<div class="w-full bg-white px-3">
					...
					<div class="mt-12  md:flex items-center">
						<div class="flex flex-col md:ml-3 md:mt-0 mt-8">
							<input type="catrgory" tabindex="0" aria-label="Enter firstcategory"
								class="w-64  text-sm font-medium leading-none text-gray-800 p-3  border-b-2"
								placeholder="categorycategory" v-model="category.catrgory" />
						</div>
					...
					<div class=" mx-[100px]">
						<div class=" pb-5 flex ">
							<button role="button"
								...
								<button @click="AddProduct" class="flex items-center justify-center ml-10 py-2 px-3 focus:outline-none bg-indigo-800 text-white border rounded-md border-gray-400 mt-7 md:mt-14 hover:bg-blue-600 focus:ring-2 focus:ring-offset-2">
...
export default {
  ...
  methods: {
    AddProduct: function() {
      axios.post("http://127.0.0.1:8001/api/categorys", {
