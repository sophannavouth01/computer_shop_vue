<template>
  <div class="auth-layout grid grid-cols-12 content-center">
    <div class="flex col-span-12 p-2 justify-center">
      <router-link class="justify-center flex" to="/">
        <img src="../../public//images/2023-12-13 16.40.18.jpg" alt="" class="w-40 h-40" />
      </router-link>
    </div>
